...
const EditBookingPage = () => {
    ...
    const [roomTypes, setRoomTypes] = useState([]); // State variable for room types
    const [selectedRoomType, setSelectedRoomType] = useState(''); // State variable for selected room type
    ...
    useEffect(() => {
        const fetchBookingDetails = async () => {
            try {
                ...
                setSelectedRoomType(response.booking.room.roomType); // Set initial room type
            } catch (error) {
        ...
        const fetchRoomTypes = async () => {
            try {
                ...
                console.log('Room Types:', response.roomTypes); // Debug log
